...
and Research (IISER), Pune are gratefully acknowledged; However, it is worth explicitly noting that while I did briefly run some scripts on the PARAM-Brahma facility that were related to my thesis project, none of the scripts or simulations run on the PARAM-Brahma supercomputer ultimately contributed in any way, shape, or form to any material presented in this thesis --- The main text is completely analytical, and Appendix \ref{App_examples} only uses very simple simulations that were run on my personal laptop; The particular simulations I ran on PARAM also did not help me gain any insight or understanding towards any of the phenomena and/or models studied in this thesis.
}
