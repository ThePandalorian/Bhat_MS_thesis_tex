\documentclass[twoside, 12pt,lot,lof]{iiser-thesis-modified} %Use the custom .cls file we have
...
%Add the bibliography and make an entry in the table of contents
\cleardoublepage
\phantomsection
\printbibliography
