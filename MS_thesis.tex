...
\cleardoublepage
\phantomsection
%I want the bibliography to be in two columns
%The \printbibheading makes sure the heading is printed before the two column environment begins.
\begin{multicols}{2}[\printbibheading]
	%Change the font for the headings
