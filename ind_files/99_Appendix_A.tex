...
\end{equation}
We will now use integration by parts to further evaluate the two parts $M(x,t)$ and $N(x,t)$. Since $P(\cdot, t)$ has compact support within the open set $\Omega \subset \mathbb{R}$ for any given $t > 0$, the function $P(x,t) \equiv 0$ on $\partial \Omega$ and the boundary term of the formula vanishes. Thus, we can use integration by parts once on $M(x,t)$ to obtain
\begin{equation}
