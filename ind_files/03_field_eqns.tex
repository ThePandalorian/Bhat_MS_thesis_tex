...
&+\frac{\mu}{N_K(t)}\int\limits_{\mathcal{T}}f(x,t)\left[b^{\textrm{(mut)}}(x|\psi) - p(x,t)\int\limits_{\mathcal{T}} b^{\textrm{(mut)}}(y|\psi)dy\right]dx\nonumber\\
&= \overline{fw} - \overline{w}\cdot\overline{f} + \frac{\mu}{N_K(t)}\int\limits_{\mathcal{T}}f(x,t)\left[b^{\textrm{(mut)}}(x|\psi) - p(x,t)\int\limits_{\mathcal{T}} b^{\textrm{(mut)}}(y|\psi)dy\right]dx\label{intermediate_for_cts_price}
\end{align}
We now observe that
\begin{equation}
...
M_{\overline{f}}(x|\psi) \coloneqq \frac{\mu}{N_K(t)}\left[\int\limits_{\mathcal{T}}f(x,t)b^{\textrm{(mut)}}(x|\psi)dx - \left(\overline{f}\int\limits_{\mathcal{T}}b^{\textrm{(mut)}}(x|\psi)dx\right)\right] 
\end{equation}
