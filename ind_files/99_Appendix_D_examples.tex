...
\begin{equation}
dp_i =  N_K(t)\left( \left[(\mathbf{Mp})_i - \mathbf{p}\cdot\mathbf{Mp}\right]p_i - \frac{1}{KN_K}\left[(\mathbf{Tp})_i - \mathbf{p}\cdot\mathbf{Tp}\right]p_i\right)dt + \frac{1}{\sqrt{K}}\left(p_i(\mathbf{Tp})_i - p_i^2(\mathbf{Tp})_i\right)^{1/2}dW_t 
\end{equation}
